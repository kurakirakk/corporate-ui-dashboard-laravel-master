<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            ...
            <img src="{{asset('assets/img/logo-badung.png')}}" alt="Logo Diskominfo Badung" class="me-3" style="height: 60px;">
            <span class="font-weight-bold text-lg text-white mt-1">E-RAPAT</span>
        </a>
    </div>
                ...
                <a class="nav-link" href="{{route('admin.rapat.index')}}">
                    <div
                        ...
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>rapat</title>
                            <g id="rapat" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">Data Rapat</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{route('admin.notulen-rapat.index')}}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>notulen_rapat</title>
                            <g id="notulen_rapat" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="nav-link-text ms-1">Notulen Rapat</span>
                </a>
            </li>
        </ul>
    </div>
